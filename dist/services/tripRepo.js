...
class TripRepository {
    //Repository function Saving, geting all trips and deleting a trip based on ID (mongo ID) using Mongo DB query functions like save(), find() or findByIdAndDelete(id)
    async saveTrip(data) {
