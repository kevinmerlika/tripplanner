...
//Creating connection between our API and Database, on this case i used MongoDB which is noSQL language and stores everything into collections and documents
//since we are not working with data that have very high level of relationships between them. Usually use Prisma ORM to interact with SQL databases like PostgreSQL if it was another case. 
